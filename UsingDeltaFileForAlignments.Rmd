...
"computingDivergenceHoffmanScript.R" is this R Markdown turned into an optimized script for hoffman. 
...
test=map2_df(.x=qLobataAlignmentsFiltered$sequence, .y=qRoburAlignmentsFiltered$sequence, ~ possibly_computeDivergence(qLobataSequence = .x, qRoburSequence = .y) )
